...
<xsl:stylesheet xmlns:xsl='http://www.w3.org/1999/XSL/Transform' version='1.0'>
	...
	<xsl:template match='/sproject'>
		...
		<body>
			<header>
				<div>
					<a href='http://www.cvut.cz/' target='_blank'><img src='./images/logo.jpg' alt='České vysoké učení technické v Praze' title='České vysoké učení technické v Praze' /></a>
					<a class='fright' onclick='main.toggleComments()'>Komentáře zapnuty</a>
				</div>
			</header>
			<main>
				...
				<!-- Description -->
				<h2><xsl:value-of select='./content/description/title'/></h2>
				<div class='paragraph'>
				...
				<xsl:if test='./content/data_model or ./course/code="BI-DBS"'>
					<h2><xsl:value-of select='./content/data_model/title'/></h2>
					<div class='paragraph'>
				...
				<xsl:if test='./content/relational_model or ./course/code="BI-SQL"'>
					<h2><xsl:value-of select='./content/relational_model/title'/></h2>
					<div class='paragraph'>
				...
				<!-- SQL queries -->
				<h2><xsl:value-of select='./content/queries/title'/></h2>
				<div class='paragraph'>
					<ol>
				...
				<!-- SQL queries - table -->
				<h2>Tabulka pokrytí kategorií SQL příkazů</h2>
				<div class='paragraph'>
					<table>
						<thead>
							<tr>
				...
				<!-- Scripts -->
				<h2><xsl:value-of select='./content/scripts/title'/></h2>
				<div class='paragraph'>
				...
				<!-- Conclusion -->
				<h2><xsl:value-of select='./content/conclussions/title'/></h2>
				<div class='paragraph'>
			...
			<footer>
				<div><a class='fright' onclick='main.scrollTop()'></a>© 2014 ČVUT - České vysoké učení technické</div>
			</footer>
		</body>
		</html>
	</xsl:template>
